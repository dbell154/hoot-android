...
public class FontFitButton extends android.support.v7.widget.AppCompatButton {
        ...
        public FontFitButton(Context context, AttributeSet attrs, int defStyle) {
            super(context, attrs, defStyle);

            TypedArray tAttrs = context.obtainStyledAttributes(attrs, R.styleable.FontFitButton, defStyle, 0);
            maxTextSize = tAttrs.getDimensionPixelSize(R.styleable.FontFitButton_maxTextSize, maxTextSize);
            minTextSize = tAttrs.getDimensionPixelSize(R.styleable.FontFitButton_minTextSize, minTextSize);
            tAttrs.recycle();
        }
