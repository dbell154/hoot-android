...
public class HelpFileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extrasBundle.isEmpty())
            return;
        String html = extrasBundle.getString("html");
        String page = "file:///android_asset/html/" + html;

        webpage.loadUrl(page);
